...
import { business, contactInfo } from "@/config/site";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: `${business.name} — Website Design & Development` },
      {
        name: "description",
        content:
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          address: {
            "@type": "PostalAddress",
            streetAddress: "4th Floor, NHeights, Phase 2, Cyber Gateway, Hi-Tech City",
